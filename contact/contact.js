function sendMail()
{
	...
	let contact= document.getElementById("call").value
	let message = document.getElementById("textarea").value
	let mailMessage = "Name: " + name + "<br> MailID: "+ mail + "<br>Contact : " + contact + "<br>Message: "+ message
	let sub = "Got New Message From " + name
	console.log(mailMessage)
	Email.send({
		Host : "smtp.elasticemail.com",
		Username : "atheeqsa2647@gmail.com",
		Password : "1143B30B8EC4581210C1A911BF7772A3D142",
		To : 'atheeqsa2647@gmail.com',
		From : "atheeqsa2647@gmail.com",
		Subject : sub,
		Body : mailMessage
	})
}
